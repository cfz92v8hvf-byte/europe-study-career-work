...
class ReviewPipelineTests(unittest.TestCase):
    ...
    def test_collects_and_translates_without_publication(self):
        ...
        self.assertEqual(result, {"review_slots": 12, "collected": 1, "translated": 1, "summaries_translated": 0, "corrected": 0, "audited": 1})
    ...
    def test_stops_collection_when_review_queue_is_full(self):
        ...
        self.assertEqual(result, {"review_slots": 0, "collected": 0, "translated": 0, "summaries_translated": 0, "corrected": 0, "audited": 12})
